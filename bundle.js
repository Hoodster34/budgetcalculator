...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file, 7, 6, 210);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "nav-btn");
    			add_location(button, file, 6, 4, 144);
    			attr_dev(div, "class", "nav-center");
    			add_location(div, file, 4, 2, 64);
    			attr_dev(nav, "class", "nav");
    			add_location(nav, file, 3, 0, 43);
    		},
    ...
    /* src\Title.svelte generated by Svelte v3.23.2 */
    ...
    /* src\Expense.svelte generated by Svelte v3.23.2 */
    const file$2 = "src\\Expense.svelte";

    // (24:4) {#if displayAmount}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$2, 24, 6, 688);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$2, 20, 8, 596);
    			attr_dev(button0, "class", "amount-btn");
    			add_location(button0, file$2, 19, 6, 535);
    			add_location(h2, file$2, 17, 4, 509);
    			attr_dev(div0, "class", "expense-info");
    			add_location(div0, file$2, 16, 2, 477);
    			attr_dev(i1, "class", "fas fa-pen");
    			add_location(i1, file$2, 30, 6, 884);
    			attr_dev(button1, "class", "expense-btn edit-btn");
    			add_location(button1, file$2, 28, 4, 792);
    			attr_dev(i2, "class", "fas fa-trash");
    			add_location(i2, file$2, 33, 6, 1011);
    			attr_dev(button2, "class", "expense-btn delete-btn");
    			add_location(button2, file$2, 32, 4, 929);
    			attr_dev(div1, "class", "expense-buttons");
    			add_location(div1, file$2, 27, 2, 757);
    			attr_dev(article, "class", "single-expense");
    			add_location(article, file$2, 15, 0, 441);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\ExpensesList.svelte generated by Svelte v3.23.2 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$3, 21, 20, 644);
    		},
    		m: function mount(target, anchor) {
    ...
    // (17:12) {#each expenses as expense, index (expense.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$3, 17, 16, 452);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(17:12) {#each expenses as expense, index (expense.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$3, 15, 8, 369);
    			add_location(section, file$3, 13, 0, 307);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\Totals.svelte generated by Svelte v3.23.2 */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(" : $");
    			t2 = text(/*total*/ ctx[1]);
    			add_location(h2, file$4, 6, 4, 106);
    ...
    /* src\ExpenseForm.svelte generated by Svelte v3.23.2 */
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$5, 47, 6, 1262);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$5, 39, 6, 987);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "name");
    			add_location(input0, file$5, 40, 6, 1025);
    			attr_dev(div0, "class", "form-control");
    			add_location(div0, file$5, 38, 4, 953);
    			attr_dev(label1, "for", "amount");
    			add_location(label1, file$5, 43, 6, 1126);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "id", "amount");
    			add_location(input1, file$5, 44, 6, 1168);
    			attr_dev(div1, "class", "form-control");
    			add_location(div1, file$5, 42, 4, 1092);
    			attr_dev(button0, "type", "submit");
    			attr_dev(button0, "class", "btn btn-block");
    			button0.disabled = /*isEmpty*/ ctx[4];
    			toggle_class(button0, "disabled", /*isEmpty*/ ctx[4]);
    			add_location(button0, file$5, 49, 4, 1336);
    			attr_dev(i, "class", "fas fa-times");
    			add_location(i, file$5, 57, 6, 1599);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "close-btn");
    			add_location(button1, file$5, 56, 4, 1531);
    			attr_dev(form, "class", "expense-form");
    			add_location(form, file$5, 37, 2, 880);
    			attr_dev(section, "class", "form");
    			add_location(section, file$5, 35, 0, 821);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$6, 5, 4, 125);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$7, 85, 2, 2255);
    			attr_dev(main, "class", "content");
    			add_location(main, file$7, 77, 0, 2008);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
